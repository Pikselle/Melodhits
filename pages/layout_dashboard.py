...
elemTitre = html.H2("Evolution des genres des musiques du Top 100", style={'color':'#ffff'})
layout_dashboard  = html.Div([html.Br(),elemTitre, html.Br(),card, html.Br(), filtre_line,html.Br(), graph_line,html.Br(),footer],style={"background-color":'black',"height": "100%", "min-height":"100vh","padding":"10px"})